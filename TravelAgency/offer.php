<?php
			...
			session_start();
			$sql="SELECT offer_table.Place_Id, place_table.Place_Name, Offer_table.Offer FROM Offer_table INNER JOIN place_table ON Offer_table.Place_Id=place_table.Place_Id Where offer_table.licence='".$_SESSION["licence"]."'";
 ...
 <div class="div3">
      	...
      	<table style="border: 1px solid black ; width:100%";>
					<tr style="border: 1px solid black">
						...
						<a href = "add_offer.php"><input type= "button" class= "button" value= " Add Offer"></a>
