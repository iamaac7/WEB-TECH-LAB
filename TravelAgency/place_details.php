			...
			<div>
				<div class="div1">
		            ...
		            <?php
						...
						echo '<input type="submit" value="Book " class = "button button3" name="bookBtn" id="bookBtnId">';
					?>
					</b><br/>
					...
					for($i=0;$i<$placephotos;$i++){
						...
						echo '<img src="'.$source.'" width="550px" height="400px"> ';
					}
				   ?>
				</div>
			</div>
