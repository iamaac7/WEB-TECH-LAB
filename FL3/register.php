	...
	<form name="form1" method="post" action="">
		<table class="table table-striped table-bordered table-condensed">
            <tr>
                <td>AIUB ID</td>
                <td>
				<input type="text" name="aiubid" id="username"  onBlur="checkusernameAvailability()" value="" class="form-control">
            ...
            <tr>
				<td>Email</td>
				<td><input type="text" name="email"  id="emailid" onBlur="checkemailAvailability()" value="" class="form-control"> <span class="error">* <?php echo $emailErr;?></span>
				</td>
